...
export default function Custom404() {
  ...
  const [floatingIcons, setFloatingIcons] = useState<Array<{ id: number; x: number; y: number; icon: any; delay: number }>>([]);
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-maginf-gray via-maginf-gray-light to-maginf-gray-dark flex items-center justify-center p-4 relative overflow-hidden">
        {/* Animated Background */}
        ...
        <div className="max-w-4xl w-full text-center relative z-10">
          ...
          {/* Message Card */}
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-6 sm:p-8 lg:p-12 text-white shadow-2xl border border-white/20">
            <div className="mb-6">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <button
                onClick={() => router.back()}
                className="group bg-white/20 hover:bg-white/30 text-white font-bold py-4 px-8 rounded-xl transition-all hover:scale-105 flex items-center justify-center gap-2 backdrop-blur-sm border border-white/30"
              >
            ...
            {/* Quick Links Grid */}
            <div>
              <p className="text-gray-300 mb-6 font-medium">Acesso rápido:</p>
                ...
                {quickLinks.map((link, index) => {
                  ...
                  return (
                    <a
                      key={index}
                      href={link.href}
                      className="group bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-2xl p-6 transition-all hover:scale-105 hover:shadow-xl flex flex-col items-center gap-3 border border-white/10 hover:border-white/30"
                    >
